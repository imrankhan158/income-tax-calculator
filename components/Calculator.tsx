        ...
        <div className='mt-2'>
            <form onSubmit={(event: FormEvent) => {
                ...
                <div>
                    ...
                    <input required value={income} onChange={(input) => setIncome(input.target.value)} type="number" name="income" id="income" className="mt-1 block w-full flex-1 rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm shadow-sm" placeholder="eg, 700000" />
                </div>
                <div className="mt-4">
                    <label htmlFor="deductions" className="block text-sm font-medium text-gray-700">Deductions</label>
                    <input value={deductions} onChange={(input) => setDeductions(input.target.value)} type="number" name="deductions" id="deductions" className="mt-1 block w-full flex-1 rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm shadow-sm" placeholder="eg, 150000" />
                </div>
